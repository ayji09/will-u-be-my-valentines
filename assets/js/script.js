...
button_yes.addEventListener('click', () =>{
    ...
    setTimeout(() => {
        image.src = '../images/content-pics/img-8.jpg';
        image.classList.remove('fade');
    }, 180 )
});